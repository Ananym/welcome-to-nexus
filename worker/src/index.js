...
// Toggle between Gemini 2.5 and 3 - controls model URL, thinkingConfig, and thoughtSignature handling
const USE_GEMINI_3 = true;
const GEMINI_MODEL = USE_GEMINI_3 ? 'gemini-3-flash-preview' : 'gemini-2.5-flash';
  ...
  while (iterations < MAX_ITERATIONS) {
    ...
    if (functionCallPart) {
      ...
      if (functionCall.name === 'query_items') {
        ...
        // Gemini 3 requires thoughtSignature preserved; Gemini 2.5 just needs functionCall
        currentContents.push({
          role: 'model',
          parts: [USE_GEMINI_3 ? functionCallPart : { functionCall }]
        });
        currentContents.push({
          role: 'user',
          parts: [{
