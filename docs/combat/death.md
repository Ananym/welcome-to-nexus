...
In practice, nobody exposes their expensive items to this risk - instead players use [Kruna](economy/kruna.md) Item Protections, which for ~$1 USD will be sacrificed instead of your item if you've applied one. You can stack these on an item, and check the remaining count by right-clicking.
