...
?> **Opinion Alert:**
NexusTK is a deeply social game. Modern MMO players are used to soloing as much as possible, and will be reluctant to put effort into finding hunting partners. This will not serve you in NTK - not only is playing alone incredibly dull, it's also noticeably slower than playing with others. I strongly encourage you to embrace what the game was made for and put effort into finding others to group with at every opportunity.
...
- Enchant/Infuse/Ingress and beyond directly multiply your weapon damage - only cast the strongest one you have. These have no duration, but you'll need to recast them if you change weapons or pass through a loading screen (including entering ATG).
...
- Poets have very little offense beyond the early levels - you'll soon need to find others to group with.
...
- There are several utility spells as a poet that can be skipped if you want to streamline the leveling process.
...
- As a poet, it's important to understand the different ways to [target your spells](combat/casting-spells.md) to play efficiently and respond quickly.
- Shortly after reaching level 99, you should be aware of the [Restore quest](quests/restore.md). Restore is a mana-scaled heal that is a significant part of a poet's kit. The quest is not too difficult, though you will need help from a stronger player. I recommend not bringing any items that break on death, making sure you know Remove Blind and Atone, and waiting until at least 20k vitality to avoid getting one-shot.
...
- Mage offense is reasonable while leveling, especially if you use the 4-way surrounding zap attacks.
...
- Static and Paralyze can stop enemies from moving or attacking, useful for reducing incoming damage. Blind only prevents enemies from moving, but lasts much longer.
...
- A handful of [mage orbs](combat/orbs.md) are available to 99+ mages from the Buyan incubator, free of charge. Orbs are items that cast spells on use without being consumed. These include scourge, a second invoke with reduced cooldown, and a more efficient attack spell. You should always pick these up as they are a powerful set of bonuses.
- As a mage, it's important to understand the different ways of targeting your spells. Spell hotkey setup for mages is quite individual. Casting via mouse is worth learning, as controlling monster positioning is easier if you don't have to spend time moving the reticle.
