...
- A handful of [mage orbs](combat/orbs.md) are available to 99+ mages from the Buyan incubator, free of charge. Orbs are items that cast spells on use without being consumed. These include scourge, a second invoke with half aethers, and a more efficient attack spell. You should always pick these up as they are a powerful set of bonuses.
