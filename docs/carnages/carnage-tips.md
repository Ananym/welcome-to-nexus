...
Kills in PK are typically done in one shot, or in one near-instant combination of attacks. To kill a "top" (someone at the top of the stat range for the carnage), you will likely need to be a top yourself, or close to it, depending on your target's armor. The target will also need to be weakened -- their sanctuary should be dispelled, they should be cursed, and possibly slept. As such, kills on tops require good team coordination.
...
Warriors are not a very offensive path in PK, as Berserk and Whirlwind are only strong enough to kill players significantly weaker than you. Look out for these opportunities, but focus mainly on healouts for your team.

At the higher end of the stat range, if well-equipped, a warrior's superior AC makes them a hard target. You can use this by staying closer to the action and blocking enemy movement at key moments -- just be careful not to get in your own top fighters' ways! You're still at risk of dying, but if the enemy spends an attack cycle trying to kill you, that's time not spent killing someone more impactful -- even better if you manage to healout.

Slash is a valuable tool for waking allies from sleep, as unlike swings or zaps it is guaranteed to land.

## Rogues

Small rogues should again focus on staying alive and maintaining healouts on key players. Leaving your team entirely to pick off small enemies while invisible sounds tempting, but you will likely do more good by not getting yourself killed.

However, do take soft targets when they become available -- a rogue's powerful attacks make them well suited for catching small, out-of-position mages. Once you're a better judge of target softness, you can start making riskier plays.
...
Small mages are nearly defenseless in PK, having poor AC and no magical defenses like poets. To stay alive you will need to consider positioning **very** carefully: stay on the outskirts, keep your team between you and the enemy mass. Stay near your team's poets -- they will be better equipped to save you than allied fighters.

Even while completely out of range of the enemy team, you can provide quick Sanctuary to teammates you see get dispelled, which can save lives.

If you find yourself under attack by an invisible rogue, don't assume you can kill them -- instead, use your doze to sleep them and run.
...
Unlike other paths, even small poets can have a massive impact on the outcome if played well, because many poet abilities are independent of stats. Poets have terrible AC, but Harden Body makes you completely invulnerable to damage, making you a hard target without a coordinated (or well-timed) attack. Harden Body has a fixed 50% success rate, so there can be a brief vulnerability window between recasts.

Don't take this as an excuse to stay close to the action -- there's still plenty of good you can do by staying safe on the outside. Given your importance, survival is paramount.
...
Of course, try to heal teammates that need it when you can. Poets are also not above using their heal to healout bigger members of their team.
