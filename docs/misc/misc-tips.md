...
Tips that don't fit elsewhere.

* At levels <15, veteran players are used to using the Thirsty Ogres in the southwest corner of Mythic Nexus to level up, as they have exactly one hitpoint and give plentiful experience.
...
* You can adjust your chat color palette using the menu in the lower left. Many players like to make sure "Shout" and "System" are set to different colours, to tell local sage messages apart from world shouts.
...
* NTK runs on 8:1 speed relative to real time, which helps when reading in-game dates.
