...
Kruna is the microtransaction currency. The items on offer are cosmetic or for utility. There is generally nothing that directly increases your strength, but some items can still be quite important. All dealings with Kruna require you to be registered.

To browse the kruna shop or buy items, go to https://nexustk.com, access the item shop via the sidebar, and log in with your [NexusTK account details](basics/registration.md) (not character details).

To get more kruna, visit the coupon shop and buy a kruna coupon instead of a registration coupon. This coupon can be used inside the item shop to add kruna to your account balance.
...
In-game, Shift-F9 can be used to preview the currently available kruna cosmetics. Cosmetic items bought directly cannot be traded between players or characters.
...
Note that while selling Kruna is lucrative compared to gathering crafting materials or collecting mythic boss drops, there are many billions of coins in the NexusTK economy. Trying to become 'rich' by NTK standards through Kruna sales alone would cost you an incomprehensible amount of money, so mind that you don't get taken advantage of.

If you end up with Kruna cosmetics that you no longer want to spend bank space on, you can permanently destroy them by feeding them to the mysterious Gelapod in the Wilderness (106/16).
