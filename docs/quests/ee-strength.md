...
All of NTK's 'kill this' quests besides alliances work on a single kill tracker system. However, since Ee-san asks you to kill so many different creatures, the limits of the kill tracker complicate this task.
...
As such, you could complete Ee-strength in a single shot if you stayed logged in without changing server for every single kill (tested!). Of course, this is not realistic for most. Bearing in mind the two boss species per mythic cave plus the several smaller species, if you want to be sure you never lose credit for a boss kill during ee strength you should return to Bon-hwa after every two pairs of bosses to turn them in.
